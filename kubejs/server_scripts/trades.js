MoreJSEvents.wandererTrades((event) => {
    // change to "MoreJSEvents.wandererTrades" in 1.19
        ...
        const trade1 = event.addTrade(32, 'minecraft:lapis_ore', 'kubejs:coin_01');
        trade1.maxUses(1);
        
        const trade2 = event.addTrade(32, 'minecraft:redstone_ore', 'kubejs:coin_01');
		trade2.maxUses(1);
		
        const trade3 = event.addTrade(16, 'minecraft:gold_ore', 'kubejs:coin_01');
		trade3.maxUses(1);
        const trade4 = event.addTrade(16, 'undergarden:depthrock_gold_ore', 'kubejs:coin_01');
		trade4.maxUses(1);
