...
const rollDice = (event, maxFaces) => {
  ...
  if (remaining > 0) {
    ...
    player.setStatusMessage(`§cThe dice are still cooling down... §e${seconds}s §cremaining.`);
    return;
  }
...
function triggerOutcome(num, player, level, server, item) {
  ...
  switch (num) {
    ...
    case 1:
      ...
      server.scheduleInTicks(100, _c => { level.explode(player, player.x, player.y, player.z, 2, false, "none"); }); break;
    ...
    case 13:
      ...
      server.scheduleInTicks(200, _c => { player.give(Item.of('minecraft:diamond')); }); break;
    ...
    case 19:
      ...
      level.spawn('minecraft:bee', b => {
        ...
        server.scheduleInTicks(300, _c => { b.discard(); });
      }); break;
    ...
    case 27:
      player.tell('§dThe world shifts...');
      applyEffect('minecraft:glowing', 100, 0);
      server.scheduleInTicks(100, _c => { player.teleportTo(level.spawnLocation.x, level.spawnLocation.y, level.spawnLocation.z); }); break;
    ...
    case 33:
      player.tell('§5Echoes of the Past...');
      applyEffect('minecraft:glowing', 200, 0);
      server.scheduleInTicks(200, _c => { player.addItemCooldown(item, 1000); }); break;
    ...
    case 38:
      player.tell('§6Midas Touch?');
      applyEffect('minecraft:glowing', 100, 0);
      server.scheduleInTicks(100, _c => { player.give(Item.of('minecraft:raw_gold_block')); }); break;
    ...
    case 43:
      ...
      level.spawn('ars_nouveau:starbuncle', s => {
        ...
        server.scheduleInTicks(400, _c => { s.discard(); });
      }); break;
    ...
    case 48:
      player.tell('§4A wilden stalks you...');
    ...
    case 51:
      playEffect(level, player, 'fail');
      player.tell('§8The graveyard claims you... §7corruption seeps through your bones.');
    ...
    case 57:
      player.tell('§aGloomper Leap!');
      applyEffect('minecraft:glowing', 100, 0);
      server.scheduleInTicks(100, _c => { applyEffect('minecraft:jump_boost', 400, 4); }); break;
    ...
    case 62: player.tell('§cWrath of the Hive!...'); applyEffect('the_bumblezone:wrath_of_the_hive', 400, 0); break;
    case 63:
      player.tell('§eBumblezone Rift...');
      applyEffect('minecraft:glowing', 200, 0);
      server.scheduleInTicks(200, _c => { player.teleportTo('the_bumblezone:the_bumblezone', player.x, 100, player.z); }); break;
    ...
    case 66:
      ...
      level.spawn('minecraft:bee', b => {
        ...
        server.scheduleInTicks(600, _c => { b.discard(); });
      }); break;
    ...
    case 82:
      playEffect(level, player, 'standard');
      player.tell('§6The dungeon feast is served...');
    ...
    case 84:
      playEffect(level, player, 'magic');
      player.tell('§dAncient knowledge crystallizes on the page...');
    ...
    case 87: player.tell('§7Molten scrap...'); player.give(Item.of('dungeonsdelight:stained_scrap', 4)); break;
    case 88: player.tell('§4Ignis Breath.'); player.setRemainingFireTicks(400); break;
    case 89: player.tell('§cRemnants of the forge...'); player.give(Item.of('embers:ember_crystal')); break;
    case 90:
      player.tell('§1The Abyss bites...');
      applyEffect('minecraft:glowing', 150, 0);
      server.scheduleInTicks(150, _c => { applyEffect('minecraft:blindness', 200, 0); player.attack(6); }); break;

    // --- 91-100: LEGENDARY ---
    case 91: player.tell('§5Echoes of the void...'); player.give(Item.of('dungeonsdelight:cleaved_ancient_egg')); break;
    case 92: player.tell('§cMonstrous power!'); applyEffect('minecraft:strength', 600, 3); break;
    case 93:
      player.tell('§1Deepling Spawn!');
      level.spawn('cataclysm:deepling', d => { d.setPosition(player.x + 3, player.y, player.z); }); break;
    case 94: player.tell('§bOcean treasures...'); player.give(Item.of('celestial_core:ocean_essence', 2)); break;
    case 95: player.tell('§5Monstrosity\'s Might.'); applyEffect('minecraft:resistance', 1200, 2); break;
    case 96:
      playEffect(level, player, 'magic');
      player.tell('§5Something ancient stirs within the die... its essence pools in your hand.');
      player.give(Item.of('kubejs:essence_monster')); break;
    case 97:
      playEffect(level, player, 'legendary');
      player.tell('§6§lQuetzalcoatl stirs... §r§ea relic of the ancient serpent god manifests before you.');
      player.give(Item.of('dawnoftimebuilder:feathered_serpent_sculpture')); break;
    case 98:
      playEffect(level, player, 'legendary');
      player.tell('§6§lArmor of the Ages! §r§eThe scales of the feathered serpent wrap around your feet.');
    ...
    case 100:
      playEffect(level, player, 'legendary');
      player.tell('§d§l⚡ GOD OF THE DIE! ⚡');
      player.tell('§5The cosmos fractures. Every blessing pours forth at once.');
...
function triggerUnfinishedOutcome(num, player, level) {
