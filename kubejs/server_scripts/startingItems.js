...
const sack = Item.of('supplementaries:sack', '{BlockEntityTag:{Items:[{Count:1b,Slot:0b,id:"bonfires:estus_flask",tag:{estus:0,reinforce_level:0,reinforce_max:10,uses:3}},{Count:16b,Slot:1b,id:"minecraft:torch"},{Count:1b,Slot:2b,id:"roughtweaks:plaster",tag:{Damage:0}},{Count:1b,Slot:3b,id:"paraglider:paraglider"},{Count:1b,Slot:4b,id:"l2hostility:hostility_orb"},{Count:1b,Slot:5b,id:"fruitsdelight:jelly_bread",tag:{JellyEffectRoot:["APPLE"]}},{Count:1b,Slot:6b,id:"lrdynamicdungeon:dungeon_pass"}],id:"minecraft:shulker_box"},display:{Name:\'{"text":"CARE PACKAGE"}\'}}');

const _CuriosAPI = Java.loadClass("top.theillusivec4.curios.api.CuriosApi");
