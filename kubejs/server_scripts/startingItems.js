const tome = Item.of('eccentrictome:tome', '{"eccentrictome:mods":{ars_nouveau:{0:{Count:1b,id:"ars_nouveau:worn_notebook"}},bloodmagic:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"bloodmagic:guide"}}},buildinggadgets2:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"buildinggadgets2:buildinggadgets2book"}}},dimdungeons:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"dimdungeons:guide_book"}}},ftbquests:{0:{Count:1b,id:"ftbquests:book"}},l2hostility:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"l2hostility:hostility_guide"}}},parcool:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"parcool:parcool_guide"}}},simplyswords:{0:{Count:1b,id:"patchouli:guide_book",tag:{"patchouli:book":"simplyswords:runic_grimoire"}}}}}');
...
PlayerEvents.loggedIn(event =>{
  ...
  Utils.server.scheduleInTicks(180, callback =>{
      ...
      startingItems.forEach(item => {
          player.inventory.setStackInSlot(item[0], item[1].copy());
      })
