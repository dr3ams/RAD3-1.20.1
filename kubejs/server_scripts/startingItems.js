...
const startingItems = [
  [0, Item.of('ftbquests:book')],
  [1, Item.of('minecraft:stone_sword')],
  [2, Item.of('minecraft:golden_pickaxe').enchant('minecraft:unbreaking', 3)],
  [3, book],
  [4, tome],
