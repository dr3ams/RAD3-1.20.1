ItemEvents.tooltip(event => {
  ...
  event.addAdvanced('kubejs:ancient_crate', (_item, _advanced, text) => {
  ...
  // --- 2. RITUAL CRATE ---
  event.addAdvanced('kubejs:ritual_crate', (_item, _advanced, text) => {
    if (!event.isShift()) {
  ...
  // --- 3. CHAOS CRATE ---
  event.addAdvanced('kubejs:chaos_crate', (_item, _advanced, text) => {
    if (!event.isShift()) {
      text.add(1, [Text.of('Hold ').gray(), Text.of('[Shift] ').gold(), Text.of('for details.').gray()])
    } else {
  ...
  // --- 4. WISHING WELL ---
  event.addAdvanced('kubejs:wishing_crate', (_item, _advanced, text) => {
    if (!event.isShift()) {
      text.add(1, [Text.of('Hold ').gray(), Text.of('[Shift] ').gold(), Text.of('for details.').gray()])
    } else {
  ...
  event.addAdvanced('kubejs:botanical_crate', (_item, _advanced, text) => {
  ...
  event.addAdvanced('kubejs:skeleton_key', (_item, _advanced, text) => {
  ...
  event.addAdvanced('kubejs:echo_crate', (_item, _advanced, text) => {
  ...
  event.addAdvanced('kubejs:mimic_heart', (_item, _advanced, text) => {
    if (event.isShift()) {
  ...
  event.addAdvanced('kubejs:quest_crate', (_item, _advanced, text) => {
