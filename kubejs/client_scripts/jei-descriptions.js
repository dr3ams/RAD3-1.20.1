...
event.add('waystones:waystone', ["This item can be bought in the shop", "", "Players can activate waystones, which will allow them to teleport back to those waystones using items such as the Warp Stone or Warp Scrolls.", "", "Waystones can also be used to travel between each other."])
...
event.add('waystones:sharestone', ["This item can be bought in the shop", "", "The sharestone is a block that can be used to teleport to other sharestones of the same color. Unlike waystones, sharestones do not require the player to activate it first.", "", "All sharestones are always available to all players, making them a great tool for multiplayer servers."])
event.add('waystones:bound_scroll', ["This item can be bought in the shop", "", "The bound scroll is a special kind of warp scroll that can be tied to a specific waystone by right-clicking the waystone with it.", "", "It can be used to teleport back to that specific waystone, or it could be given to another player and allow them to easily get to the bound waystone even if they have not activated it yet."])
event.add('waystones:warp_scroll', ["This item can be bought in the shop", "", "The warp scroll is the one-time use version of the Warp Stone. It can be used to teleport to any of your activated waystones."])
event.add('waystones:warp_stone', ["This item can be bought in the shop", "", "The warp stone allows you to teleport to any of your activated waystones.", "", "Once used, a cooldown period starts before you can use a warp stone again. This cooldown is tied to your player, not the warp stone itself, so there is no use in having multiple warp stones."])
event.add('waystones:warp_plate', ["This item can be bought in the shop", "", "Warp Plates can be compared to teleporting pressure plates. Stand on one and you will get teleported to another warp plate. Warp Plates are attuned to each other by inserting the Attuned Shard of another warp plate."])
