ItemEvents.tooltip((event) => {
  ...
  event.addAdvanced('kubejs:living_branch_bridging', (_item, _advanced, text) => {
  ...
  // 3. Buzzing Branch
  event.addAdvanced('kubejs:buzzing_living_branch', (_item, _advanced, text) => {
  ...
  event.addAdvanced('kubejs:gamble_coin', (_item, _advanced, text) => {
  ...
  event.addAdvanced('lrdynamicdungeon:dungeon_pass', (_item, _advanced, text) => {
    text.add(Text.of(''));
  ...
  tooltipData.forEach(item => {
    event.addAdvanced(item.id, (_stack, _advanced, text) => {
  ...
  dice.forEach(die => {
    event.addAdvanced(die.id, (_item, _advanced, text) => {
